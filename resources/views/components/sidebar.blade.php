<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    <div class="app-brand demo">
        <div class="app-brand justify-content-center">
                <img src="{{('black.jpeg')}}" width="100px" alt="">
        </div>
    ...
    <ul class="menu-inner py-1"style="margin-top:10px;">
        ...
        @if(auth()->user()->role == 'admin')
            ...
            <!-- tambahan menu pegawai -->
            <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('transaction.*')}}">
            <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-book"></i>
                <div data-i18n="{{ __('menu.transaction.menu') }}">Pegawai</div>
            </a>
            <ul class="menu-sub">
                    <!-- <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('transaction.incoming.*') || \Illuminate\Support\Facades\Route::is('transaction.disposition.*') ? 'active' : '' }}">
                        <a href="{{ route('transaction.gajipegawai.index') }}" class="menu-link">
                            <div
                                data-i18n="{{ __('menu.transaction.incoming_letter') }}">Gaji Pegawai</div>
                        </a>
                    </li> -->
                    <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('transaction.outgoing.*') ? 'active' : '' }}">
                        <a href="{{ route('transaction.gajipegawai.index') }}" class="menu-link">
                            <div
                                data-i18n="{{ __('menu.transaction.outgoing_letter') }}">Gaji Pegawai</div>
                        </a>
                    </li>
                    <li class="menu-item {{ \Illuminate\Support\Facades\Route::is('transaction.outgoing.*') ? 'active' : '' }}">
                        <a href="{{ route('transaction.absensipegawai.index') }}" class="menu-link">
                            <div
                                data-i18n="{{ __('menu.transaction.outgoing_letter') }}">Absensi Pegawai</div>
                        </a>
                    </li>
                </ul>
            </li>
