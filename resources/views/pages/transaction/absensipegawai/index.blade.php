...
@section('content')
    <x-breadcrumb
        :values="[__('Absensi Pegawai')]">
        <a href="{{ route('transaction.absensipegawai.create') }}" class="btn btn-primary">{{ __('menu.general.create') }}</a>
    </x-breadcrumb>

    @foreach($data as $letter)
    @if($letter->classification && $letter->classification->code === '0002')
        <div class="card mb-4">
