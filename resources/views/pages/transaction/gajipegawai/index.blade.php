...
@section('content')
    <x-breadcrumb
        :values="[__('Gaji Pegawai')]">
        <a href="{{ route('transaction.gajipegawai.create') }}" class="btn btn-primary">{{ __('menu.general.create') }}</a>
    </x-breadcrumb>

    @foreach($data as $letter)
    @if($letter->classification && $letter->classification->code === '0003')
        <div class="card mb-4">
