...
class AbsensiPegawaiController extends Controller
{
    ...
    {
        return view('pages.transaction.absensipegawai.index', [
    ...
    {
        return view('pages.transaction.absensipegawai.agenda', [
    ...
    public function print(Request $request): View
    {
        ...
        return view('pages.transaction.absensipegawai.print', [
    ...
    {
        return view('pages.transaction.absensipegawai.create', [
    ...
    public function store(StoreLetterRequest $request): RedirectResponse
    {
        try {
            ...
            return redirect()
                ->route('transaction.absensipegawai.index')
    ...
    {
        return view('pages.transaction.absensipegawai.show', [
    ...
    {
        return view('pages.transaction.absensipegawai.edit', [
            'data' => $outgoing,
            'classifications' => Classification::all(),
        ]);
    }
