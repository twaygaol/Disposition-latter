...
class GajiPegawaiController extends Controller
{
    ...
    {
        return view('pages.transaction.gajipegawai.index', [
    ...
    {
        return view('pages.transaction.gajipegawai.agenda', [
    ...
    {
        return view('pages.transaction.gajipegawai.create', [
    ...
    public function store(StoreLetterRequest $request): RedirectResponse
    {
        try {
            ...
            return redirect()
                ->route('pages.transaction.gajipegawai.index')
                ->with('success', __('Berhasil'));
    ...
    {
        return view('pages.transaction.gajipegawai.show', [
    ...
    {
        return view('pages.transaction.gajipegawai.edit', [
            'data' => $outgoing,
            'classifications' => Classification::all(),
        ]);
    }
    ...
    public function destroy(Letter $outgoing): RedirectResponse
    {
        try {
            $outgoing->delete();
            return redirect()
                ->route('transaction.gajipegawai.index')
