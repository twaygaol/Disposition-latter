...
Route::middleware(['auth'])->group(function () {
    ...
    Route::prefix('transaction')->as('transaction.')->group(function () {
        ...
        // tambahan revisi
        Route::resource('absensipegawai', \App\Http\Controllers\AbsensiPegawaiController::class);
        Route::resource('gajipegawai', \App\Http\Controllers\GajipegawaiController::class);
